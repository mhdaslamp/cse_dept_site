    ...
    <footer className="flex flex-col sm:flex-row justify-between px-24 py-8 bg-white text-gray-800 w-full font-bebasneue relative">
      ...
      <div className="relative isolate">
        ...
        <div className="grid grid-cols-2 gap-x-[7.125rem]">
          <Link
            className="text-16 block text-gray-600 hover:text-blue-500 min-w-[7.5rem] mb-1"
            href="#"
          >
            HOME
          </Link>
          <Link
            className="block text-gray-600 hover:text-blue-500 min-w-[7.5rem] mb-1"
            href="#"
          >
            PEOPLE
          </Link>
          <Link
            className="block text-gray-600 hover:text-blue-500 min-w-[7.5rem]"
            href="#"
          >
            PLACEMENTS
          </Link>
