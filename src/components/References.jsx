...
export default function References() {
  ...
  return (
    <div className="text-black "  ref={animatedRef} >
      ...
      <div className="lg:w-[60%] w-screen px-5   lg:px-0 ">
        <div ref={text2} className="flex lg:justify-end w-full"><p className="text-[56px] font-bebasneue mt-[1rem] mb-[1rem] font-bold">.NEW POSTS</p></div>
