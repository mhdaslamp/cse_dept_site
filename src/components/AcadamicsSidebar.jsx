...
const AcadamicsSidebar = () => {
    ...
    return (
        <div className={`sidebar z-10 fixed flex flex-col justify-center h-screen left-0 cursor-pointer  ${isMobile ? 'hidden' : ''}`}>
            ...
            {open && (
                <div className="sidebar-popup  w-[133px] h-[502px] ml-[26px] bg-black text-white justify-between opacity-[0px] gap-0 border-[0px]"  onMouseLeave={() => setOpen(false)}>
                    <ul className="flex flex-col items-center font-bebasneue text-base/[19.2px] font-normal text-center tracking-[0.04rem] ">
                        <li className="p-[25px]">PO, PsO<br/>and<br/>PEO</li>
                        <li className="p-[25px]">Programmes<br/>and Syllabi</li>
                        <li className="p-[25px]">Courses</li>
                        <li className="p-[25px]">Academic<br/>Calender</li>
