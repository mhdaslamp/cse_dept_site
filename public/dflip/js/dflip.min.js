...
(function e(t, i) {
    ...
    var V = function (e, n) {
        ...
        var H = (c.endPage = i(h.div, {
            class:
                r + ' ' + a + '-end ' + (s ? u.icons['start'] : u.icons['end']),
    ...
    function q() {
        G = (function (e) {
            ...
            function t(t) {
                ...
                a.spotLight.intensity = p(
                    t.spotLightIntensity,
                ...
                a.dispose = function () {
                    ...
                    if (a.options.scrollWheel == true) {
                        a.container[0].removeEventListener(
                            'mousewheel',
                            v,
                            false
                        );
                ...
                var m = function (e) {
                    ...
                    if (
                        ...
                        a.zoomDirty = true;
                        var t = l.getVectorAvg(
                                l.getTouches(e, a.container.offset())
                            ),
                            i = l.calculateScale(
                                a.startTouches,
                                l.getTouches(e)
        ...
        var a = (function (e) {
            ...
            i.prototype.updatePage = function (e) {
                ...
                var f = a
                    ? 0
                    : (0.5 - Math.abs(l / 2 - e) / l) / this.stiffness;
                var h = 1;
                ...
                for (var P = 0; P < c; P++) {
                    ...
                    if (y.isFlipping == false) {
                        if (Math.abs(L - S) > 20 && y.skipFlip == false) {
                            ...
                            y.skipFlip = false;
                            y.newStiffness = isNaN(y.newStiffness)
                                ? 0
                                : y.newStiffness;
                            if (
                                y.angles[1] != S ||
                    ...
                    y.position.x =
                        y.isEdge == true && y.isFlipping == false
                            ? P < p
                                ? M
                                : -M
                            : 0;
        ...
        n.prototype = {
            ...
            resize: function () {
                ...
                var k =
                    ...
                    R =
                        o.paddingBottom +
                        (o.controlsPosition == t.CONTROLSPOSITION.BOTTOM
                            ? T
                            : 0),
                    F = o.paddingLeft;
                ((k = isNaN(k) ? 0 : S(k, 0, k)),
                ...
                if (h) {
                    ...
                    r.orbitControl.update();
                    r.orbitControl.mouseButtons.ORBIT =
                        P != 1 ? -1 : THREE.MOUSE.RIGHT;
                    r.orbitControl.mouseButtons.PAN =
                        P != 1 ? THREE.MOUSE.LEFT : -1;
                } else {
                    n.pageWidth = Math.round(b);
                    n.fullWidth = n.pageWidth * 2;
                    n.height = Math.round(m);
                    var ie = (n.shiftHeight = Math.round(
                            S((Z - _ + M) / 2, 0, Z)
                        )),
                        ne = (n.shiftWidth = Math.round(
                            S((Y - N + D) / 2, 0, Y)
                        ));
                    if (P == 1) {
                        n.left = 0;
            ...
            setPageMode: function (e) {
                if (e == true) {
                    ...
                    this.ui.pageMode.attr(
                        'title',
                        this.options.text.doublePageMode
                    );
                    this.target.pageMode = t.PAGE_MODE.SINGLE;
                } else {
                    this.ui.pageMode.removeClass(
                        this.options.icons['doublepage']
                    );
                    this.ui.pageMode.html(
                    ...
                    this.ui.pageMode.attr(
                        'title',
                        this.options.text.singlePageMode
                    );
    ...
    var Y = (function (e) {
        ...
        function a(e, a, o, r) {
            ...
            s.pdfRenderQuality =
                o.pdfRenderQuality || t.defaults.pdfRenderQuality;
            s.flipbook = r;
            s.waitPeriod = 50;
            s.maxLength = 297;
            s.enableDebug = false;
            ...
            if (
                ...
                var h = function () {
                    if (s) {
                        ...
                        s.updateInfo(
                            s.options.text.loading + ' PDF Worker ...'
                        );
                        var e = document.createElement('a');
                        e.href = n.pdfjsWorkerSrc;
                        if (e.hostname !== window.location.hostname) {
                            s.updateInfo(
                                s.options.text.loading + ' PDF Worker CORS ...'
                            );
                            i.ajax({
                                url: n.pdfjsWorkerSrc,
                                cache: true,
                                success: function (e) {
                                    n.pdfjsWorkerSrc = t.createObjectURL(
                                        e,
                                        'text/javascript'
                                    );
                                    d();
                ...
                if (window.pdfjsLib == null) {
                    if (s) {
                        s.updateInfo(
                            s.options.text.loading + ' PDF Service ...'
                        );
                        M(
            ...
            var a = function () {
                ...
                if (e.activeThumb != e.targetObject._activePage) {
                    var o =
                        ...
                        e.targetObject.thumbContainer.hasClass(
                            'df-sidemenu-visible'
                        );
                    if (o) {
        ...
        a.prototype.getPage = function (e, a, o) {
            ...
            function f(e, i, n, a) {
                ...
                if (r.webgl == true) {
                    u =
                        O(r.cacheIndex) /
                        (r.pageRatio > 1 ? c.width / l : c.height);
                }
        ...
        a.prototype.getAnnotations = function (e) {
            ...
            if (e > 0 && e <= n.pageCount) {
                if (n.contentSourceType == c.PDF) {
                    ...
                    var l = e;
                    if (
                        n.options.pageSize == t.PAGE_SIZE.DOUBLEINTERNAL &&
                        e > 2
                    ) {
                        l = Math.ceil((e - 1) / 2) + 1;
                    }
    ...
    var K = (function () {
        ...
        e.prototype = {
            ...
            tween: function (e) {
                ...
                var r =
                    i.parent.corner == t.CORNERS.BL ||
                    i.parent.corner == t.CORNERS.BR;
    ...
    var X = (function (e) {
        ...
        function s(e, n) {
            ...
            var u = function (e) {
                    ...
                    if (
                        ...
                        s.zoomDirty = true;
                        var n = l.getVectorAvg(
                                l.getTouches(e, s.container.offset())
                            ),
                            a = l.calculateScale(
                                s.startTouches,
                                l.getTouches(e)
                ...
                f = function (e) {
                    if (e.touches != null && e.touches.length == 0) {
                        ...
                        if (s.zoomDirty == true) {
                            s.previewObject.contentProvider.zoomScale =
                                l.limitAt(
                                    s.previewObject.contentProvider.zoomScale *
                                        s.lastScale,
                                    1,
        ...
        s.prototype = {
            ...
            pan: function (e) {
                ...
                this.top = Math.round(
                    S(a, -this.shiftHeight, this.shiftHeight)
                );
                if (i == 1) {
                    this.left = 0;
                    this.top = 0;
            ...
            for (var h = 0; h < u; h++) {
                ...
                if (p.isFlipping == false) {
                    if (v !== g && p.skipFlip == false) {
                        ...
                        p.element.addClass(
                            h < f ? 'df-left-side' : 'df-right-side'
                        );
                        p.side = v;
                    }
                }
    ...
    var Q = (function (e) {
        ...
        function a(n, a, o) {
            ...
            if (r.options.isLightBox) {
                window.dfLightBox.closeButton.addClass(
                    r.options.icons['close']
                );
            }
...
var ThumbList = (function e() {
    ...
    t.prototype.reset = function (e) {
        ...
        this.cachedItemsLen = this.screenItemsLen + this.offsetItems * 2;
        var t =
            parseInt(this.lastRepaintY / this.itemHeight, 10) -
            this.offsetItems;
        this.needReset = true;
        ...
        extractText: function e() {
            ...
            function o(e) {
                a.pdfViewer.getPageTextContent(e).then(function i(n) {
                    ...
                    if (
                        e + 1 <
                        a.pdfViewer.contentProvider.pdfDocument.numPages
                    ) {
                        o(e + 1);
                    }
                });
            ...
            if (i !== 'true') {
                ...
                if (t.hasClass('_df_book')) {
                    ...
                    if (t.hasClass('_df_thumb')) {
                        ...
                        var s = t.html().trim();
                        t.html('');
                        var l = e("<span class='_df_book-title'>")
                            .html(s)
                            .appendTo(r);
